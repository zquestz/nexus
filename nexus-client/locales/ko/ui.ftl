...
files-search-query-too-short = 검색어가 너무 짧습니다 (최소 { $min_length }자)
files-search-query-too-long = 검색어가 너무 깁니다 (최대 { $max_length }자)
...
err-duration-too-long = 기간이 너무 깁니다 (최대 { $max }자)
