...
label-show-channel-notifications = Показывать уведомления о входе/выходе из канала
...
err-leave-no-channel = Вы должны быть в канале, чтобы использовать /leave без аргументов
