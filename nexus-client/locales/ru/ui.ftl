...
title-channel-members = Участники
...
placeholder-fingerprint = Отпечаток SHA-256 (необязательно)
...
placeholder-persistent-channels = #канал1 #канал2 (через пробел)
placeholder-auto-join-channels = #канал1 #канал2 (через пробел)
...
label-public-address = Публичный адрес:
...
label-allow-voice-bypass = Разрешить обход для голоса
...
label-persistent-channels = Постоянные каналы:
label-auto-join-channels = Авто-вход в каналы:
...
permission-voice_listen = Голосовое Прослушивание
permission-voice_talk = Голосовой Разговор
permission-group_create = Создание Группы
permission-group_edit = Редактирование Группы
permission-group_delete = Удаление Группы
...
tooltip-transfer-remove = Удалить
tooltip-transfer-open-folder = Открыть папку
tooltip-transfer-move-up = Вверх
...
tooltip-server-public-yes = Да
tooltip-server-public-no = Нет
...
empty-no-channel-members = Нет участников в канале
user-management-loading = Загрузка пользователей…
user-management-no-users = Пользователи не найдены
group-form-name = Название
group-management-no-groups = Группы не настроены
group-management-loading = Загрузка групп…
group-management-shared = Общая Группа
user-management-group = Группа
...
files-not-found = '{ $name }' не найден
files-home = Главная
files-root = Корень
...
files-search-query-too-short = Поисковый запрос слишком короткий (мин. { $min_length } байт)
files-search-query-too-long = Поисковый запрос слишком длинный (макс. { $max_length } байт)
files-search-query-invalid = Поисковый запрос содержит недопустимые символы
...
err-dir-name-too-long = Имя папки слишком длинное (макс. { $max } байт)
...
msg-connected-to = Подключено к { $server }
msg-server-version = Версия сервера: { $version }
msg-logged-in-as = Вошли как { $nickname }
msg-logged-in-as-admin = Вошли как { $nickname } [админ]
msg-logged-in-as-shared = Вошли как { $nickname } ({ $username })
msg-logged-in-as-shared-admin = Вошли как { $nickname } ({ $username }) [админ]
msg-user-kicked-success = Пользователь успешно исключён
msg-user-kicked-success-name = Пользователь '{ $nickname }' успешно исключён
msg-chat-join = { $nickname } присоединился к каналу
msg-chat-leave = { $nickname } покинул канал
msg-chat-renamed = { $old } теперь известен как { $new }
...
msg-user-deleted-name = Пользователь '{ $username }' успешно удалён
msg-user-updated = Пользователь успешно обновлён
msg-user-updated-name = Пользователь '{ $username }' успешно обновлён
...
msg-group-created = Группа "{ $name }" создана
msg-group-updated = Группа "{ $name }" обновлена
msg-group-deleted = Группа "{ $name }" удалена
...
msg-secret-set = Секретный режим включён пользователем { $username }
...
err-failed-update-server-info = Не удалось обновить информацию о сервере: { $error }
...
err-no-certificates-in-chain = Сервер не предоставил сертификат.
...
err-fingerprint-invalid = Неверный формат отпечатка. Ожидается 95 символов в верхнем регистре в шестнадцатеричной системе, разделённых двоеточиями.
err-bookmark-name-duplicate = Закладка с именем "{ $name }" уже существует.
err-bookmark-endpoint-duplicate = Закладка с этим адресом, портом, именем пользователя и псевдонимом уже существует.
err-bookmark-edit-stale = Эта закладка была изменена из-за переименования на сервере. Откройте форму редактирования заново, чтобы загрузить актуальные данные перед сохранением.
...
err-password-too-long = Пароль слишком длинный (макс { $max } байт)
...
err-trust-reason-too-long = Причина доверия слишком длинная (макс. { $max } символов)
err-trust-reason-invalid-characters = Причина доверия содержит недопустимые символы
...
err-fingerprint-mismatch = Отпечаток сертификата сервера изменился. Проверьте и примите новый отпечаток, чтобы продолжить.
err-fingerprint-interception = Обнаружен перехват TLS. Отпечаток, сообщённый сервером, отличается от наблюдаемого.
...
cmd-me-desc = Отправить сообщение-действие (например, /me машет рукой)
cmd-me-usage = Использование: /{ $command } <действие>
err-me-no-target = Используйте /{ $join } для входа в канал или /{ $msg } для отправки действия пользователю
cmd-message-desc = Отправить сообщение пользователю
cmd-message-usage = Использование: /{ $command } <имя_пользователя> <сообщение>
cmd-ping-desc = Измерить задержку до сервера
cmd-ping-usage = Использование: /{ $command }
ping-result = Ответ: { $ms }мс
...
cmd-topic-arg-clear = очистить
cmd-topic-set-usage = Использование: /{ $command } установить <тема>
...
cmd-focus-desc = Переключиться на чат сервера, канал или окно сообщений пользователя
cmd-focus-usage = Использование: /{ $command } [#канал|имя_пользователя]
cmd-focus-not-found = Пользователь не найден: { $name }
cmd-focus-channel-not-joined = Вы не на канале: { $channel }
cmd-list-desc = Показать подключённых/всех пользователей
cmd-list-arg-all = все
cmd-list-usage = Использование: /{ $command } [все]
...
cmd-list-all-no-permission = Для просмотра всех пользователей требуется разрешение user_edit или user_delete
cmd-list-all-output = Пользователи: { $users } ({ $count } { $count ->
    [one] пользователь
    [few] пользователя
   *[other] пользователей
})
...
cmd-window-usage = Использование: /{ $command } [следующая|предыдущая|закрыть [имя_пользователя]]
cmd-window-arg-next = следующая
cmd-window-arg-prev = предыдущая
cmd-window-arg-close = закрыть
...
cmd-join-desc = Присоединиться или создать канал
cmd-join-usage = Использование: /{ $command } #канал
cmd-leave-desc = Покинуть канал
cmd-leave-usage = Использование: /{ $command } [#канал]
cmd-channels-desc = Показать доступные каналы
cmd-channels-usage = Использование: /{ $command }
cmd-secret-desc = Переключить секретный режим текущего канала
cmd-secret-usage = Использование: /{ $command } [вкл|выкл]
cmd-secret-arg-on = вкл
cmd-secret-arg-off = выкл
err-secret-no-channel = Эта команда работает только в канале
err-secret-permission-denied = У вас нет разрешения изменять секретный режим канала
msg-secret-already-on = Канал уже секретный
msg-secret-already-off = Канал уже публичный
msg-secret-enabled = Канал теперь секретный
msg-secret-disabled = Канал теперь публичный
msg-secret-status-on = Этот канал секретный
msg-secret-status-off = Этот канал публичный
...
err-public-address-too-long = Публичный адрес слишком длинный (максимум { $max } байт)
...
err-server-address-empty = Требуется адрес сервера
err-server-address-too-long = Адрес сервера слишком длинный (максимум { $max } байт)
err-server-address-contains-scheme = Адрес сервера не должен содержать URL-схему
err-server-address-contains-path = Адрес сервера не должен содержать путь
err-server-address-contains-userinfo = Адрес сервера не должен содержать имя пользователя
err-server-address-contains-whitespace = Адрес сервера не должен содержать пробелы
err-server-address-contains-port = Адрес сервера не должен содержать порт
err-server-address-invalid-format = Адрес сервера не является допустимым именем хоста или IP-адресом
...
err-group-name-too-long = Название группы превышает максимальную длину ({ $max } символов)
...
err-group-shared-mismatch = Общие аккаунты могут быть назначены только общим группам
...
err-topic-no-channel = Эта команда работает только в канале
err-join-channel = Не удалось присоединиться к каналу: { $error }
err-leave-channel = Не удалось покинуть канал: { $error }
err-list-channels = Не удалось получить список каналов: { $error }
err-channel-empty = Имя канала не может быть пустым
err-channel-too-short = Имя канала должно содержать хотя бы один символ после #
err-channel-too-long = Имя канала слишком длинное (макс. { $max } символов)
err-channel-missing-prefix = Имя канала должно начинаться с #
err-channel-invalid-characters = Имя канала содержит недопустимые символы
err-leave-no-channel = Вы должны быть в канале, чтобы использовать /{ $command } без аргументов
err-not-in-channel = Вы не находитесь в канале { $channel }
err-leave-already-pending = Уже ожидается ответ от сервера
err-uri-connection-failed = Не удалось подключиться к { $host }: { $error }
...
event-voice-left = Покинул голосовой чат
event-chat-join = Вход в чат
event-chat-leave = Выход из чата
...
event-settings-show-toast = Показать тост
settings-toast-test = Тест
...
notification-user-connected = Пользователь подключился
...
notification-voice-joined = Пользователь присоединился к голосовому чату
notification-voice-joined-details = {$username} присоединился к голосовому чату в {$target}
notification-voice-joined-user = {$username} присоединился к голосовому чату
notification-voice-left = Пользователь покинул голосовой чат
notification-voice-left-details = {$username} покинул голосовой чат в {$target}
notification-voice-left-user = {$username} покинул голосовой чат
notification-chat-join = Пользователь присоединился к каналу
notification-chat-join-details = {$username} присоединился к {$channel}
notification-chat-leave = Пользователь покинул канал
notification-chat-leave-details = {$username} покинул {$channel}
...
err-voice-proxy-not-supported = Голосовой чат заблокирован при использовании прокси. Включите «Разрешить обход для голоса» в Настройки > Сеть.
err-ptt-init-failed = Система PTT недоступна
warn-voice-processor-disabled = Обработка аудио отключена: { $error }
...
# PTT release delay
ptt-delay-off = Выкл
ptt-delay-100ms = 100мс
ptt-delay-300ms = 300мс
...
toast-link-copied = Ссылка скопирована
...
err-tracker-name-duplicate = Трекер с именем "{ $name }" уже существует.
tooltip-tracker-browser = Трекеры
title-trackers = Трекеры
tooltip-tracker-edit = Изменить трекер
tooltip-tracker-remove = Удалить трекер
...
err-tracker-query-unreachable = Трекер недоступен: возможно, он не работает или адрес указан неверно.
err-tracker-query-refused = Трекер отклонил соединение: возможно, он ограничивает частоту запросов с вашего IP или недоступен.
...
err-tracker-query-invalid = Трекер отклонил запрос: недопустимые данные.
err-tracker-query-rejected = Трекер отклонил запрос: { $message }
err-tracker-address-duplicate = Трекер с этим адресом и портом уже существует.
