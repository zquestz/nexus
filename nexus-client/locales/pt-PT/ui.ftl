...
title-add-server = Adicionar Servidor
...
placeholder-server-name-optional = Nome do Servidor (opcional)
placeholder-server-address = Endereço IPv6 do Servidor
placeholder-server-name = Nome do Servidor
placeholder-ipv6-address = Endereço IPv6
...
msg-username-error = Erro
msg-username-info = Info
msg-username-broadcast-prefix = [DIFUSÃO]
...
err-bookmark-connection-failed = Falha na ligação do marcador: { $error }
