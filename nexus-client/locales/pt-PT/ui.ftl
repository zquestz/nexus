...
transfer-save-metadata-failed = Falha ao ler os metadados do ficheiro: { $error }
transfer-save-permissions-failed = Falha ao definir as permissões do ficheiro: { $error }
