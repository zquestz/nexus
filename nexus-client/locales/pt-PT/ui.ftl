...
tab-files = Ficheiros
tab-channels = Canais
label-connections-short = Conexões:
label-transfers-short = Transferências:
...
label-version-value = Versão { $version }
...
err-current-password-required = A palavra-passe actual é obrigatória
...
transfer-error-hash-mismatch-file = Falha na verificação do ficheiro: { $file }
