...
placeholder-server-name-optional = Nom du serveur (optionnel)
placeholder-server-address = Adresse IPv6 du serveur
placeholder-server-name = Nom du serveur
placeholder-ipv6-address = Adresse IPv6
...
label-auto-connect = Connexion automatique au démarrage
