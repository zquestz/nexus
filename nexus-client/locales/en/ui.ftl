...
cmd-serverinfo-header = Server Information:
cmd-serverinfo-name = Name: { $name }
cmd-serverinfo-description = Description: { $description }
cmd-serverinfo-version = Version: { $version }
cmd-serverinfo-topic = Chat Topic: { $topic }
cmd-serverinfo-topic-set-by = Topic Set By: { $username }
cmd-serverinfo-max-connections = Max Connections Per IP: { $count }