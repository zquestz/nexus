...
placeholder-fingerprint = SHA-256 fingerprint (optional)
...
placeholder-download-location = No download location set
...
label-admin = Admin
label-bandwidth-section = Bandwidth
label-bandwidth-weight = Bandwidth Weight:
label-chat-section = Chat
label-files-section = Files
label-general-section = General
label-inherit-bandwidth-weight = Inherit Bandwidth Weight
label-max-outbound-rate = Max Outbound (Mbps):
label-unlimited = Unlimited
label-scheduler-chunk-size = Scheduler Chunk Size (Bytes):
...
chat-history-30-days = 30 Days
chat-history-14-days = 14 Days
chat-history-7-days = 7 Days
chat-history-disabled = Disabled
label-auto-away = Auto-Away:
label-auto-away-message = Auto-Away Message:
auto-away-off = Off
...
label-public-address = Public Address:
...
label-allow-voice-bypass = Allow Voice Bypass
...
permission-connection_monitor = Connection Monitor
permission-voice_listen = Voice Listen
permission-voice_talk = Voice Talk
...
tooltip-transfer-remove = Remove
tooltip-transfer-open-folder = Open Folder
tooltip-transfer-move-up = Move Up
...
files-not-found = '{ $name }' not found
files-home = Home
files-root = Root
...
files-search-query-too-short = Search query is too short (min { $min_length } bytes)
files-search-query-too-long = Search query is too long (max { $max_length } bytes)
files-search-query-invalid = Search query contains invalid characters
...
err-dir-name-too-long = Directory name is too long (max { $max } bytes)
...
msg-user-created-name = User '{ $username }' created successfully
msg-user-deleted = User deleted successfully
msg-user-deleted-name = User '{ $username }' deleted successfully
msg-user-updated = User updated successfully
msg-user-updated-name = User '{ $username }' updated successfully
...
err-nickname-too-long = Nickname is too long (max { $max } characters)
err-nickname-invalid = Nickname contains invalid characters
err-password-too-long = Password is too long (max { $max } bytes)
...
err-trust-reason-too-long = Trust reason is too long (max { $max } characters)
err-trust-reason-invalid-characters = Trust reason contains invalid characters
...
err-public-address-too-long = Public address is too long (max { $max } bytes)
...
err-server-address-empty = Server address is required
err-server-address-too-long = Server address is too long (max { $max } bytes)
err-server-address-contains-scheme = Server address must not include a URL scheme
err-server-address-contains-path = Server address must not include a path
err-server-address-contains-userinfo = Server address must not include a username
err-server-address-contains-whitespace = Server address must not contain whitespace
err-server-address-contains-port = Server address must not include a port
err-server-address-invalid-format = Server address is not a valid hostname or IP address
...
cmd-ping-desc = Measure latency to server
cmd-ping-usage = Usage: /{ $command }
ping-result = Pong: { $ms }ms
cmd-userinfo-desc = Show information about a user
cmd-userinfo-usage = Usage: /{ $command } <nickname>
cmd-kick-desc = Kick a user from the server
cmd-kick-usage = Usage: /{ $command } <nickname> [reason]
...
cmd-focus-desc = Focus server chat, a channel, or a user's message tab
cmd-focus-usage = Usage: /{ $command } [#channel|nickname]
cmd-focus-not-found = User not found: { $name }
cmd-focus-channel-not-joined = You are not in channel: { $channel }
...
cmd-window-usage = Usage: /{ $command } [next|prev|close [nickname]]
...
event-settings-show-toast = Show Toast
...
notification-user-connected = User connected
...
disconnect-reason-label = Reason:
disconnect-reason-placeholder = Optional reason
button-kick = Kick
button-ban = Ban
...
err-leave-no-channel = You must be in a channel to use /{ $command } without arguments
err-not-in-channel = You are not in channel { $channel }
err-leave-already-pending = Already waiting for server response
err-uri-connection-failed = Failed to connect to { $host }: { $error }
...
err-voice-proxy-not-supported = Voice is blocked while using a proxy. Enable Allow Voice Bypass in Settings > Network.
