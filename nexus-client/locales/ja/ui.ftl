...
placeholder-server-name-optional = サーバー名（任意）
placeholder-server-address = サーバーIPv6アドレス
placeholder-server-name = サーバー名
placeholder-ipv6-address = IPv6アドレス
...
msg-username-system = システム
msg-username-error = エラー
msg-username-info = 情報
msg-username-broadcast-prefix = [ブロードキャスト]
