...
files-search-query-too-short = 検索クエリが短すぎます（最小{ $min_length }文字）
files-search-query-too-long = 検索クエリが長すぎます（最大{ $max_length }文字）
...
err-duration-too-long = 期間が長すぎます（最大{ $max }文字）
