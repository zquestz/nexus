...
tab-files = File
tab-channels = Canali
label-connections-short = Connessioni:
label-transfers-short = Trasferimenti:
...
label-version-value = Versione { $version }
...
user-info-idle-since = Inattivo da:
...
transfer-error-hash-mismatch-file = Verifica del file fallita: { $file }
