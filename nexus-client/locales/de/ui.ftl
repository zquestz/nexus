...
button-accept-new-certificate = Akzeptieren
...
title-bookmark-create = Lesezeichen erstellen
title-bookmark-edit = Lesezeichen bearbeiten
...
title-group-create = Gruppe erstellen
title-group-edit = Gruppe bearbeiten
...
title-server-info-edit = Server-Info bearbeiten
...
placeholder-fingerprint = SHA-256-Fingerabdruck (optional)
...
placeholder-download-location = Kein Download-Speicherort festgelegt
placeholder-persistent-channels = #kanal1 #kanal2 (durch Leerzeichen getrennt)
placeholder-auto-join-channels = #kanal1 #kanal2 (durch Leerzeichen getrennt)
...
label-show-channel-events = Beitritts-/Verlassensereignisse anzeigen
...
label-log-level = Protokollstufe:
label-log-level-none = Keine
label-log-level-error = Fehler
label-log-level-warn = Warnung
...
label-public-address = Öffentliche Adresse:
...
label-allow-voice-bypass = Sprach-Bypass zulassen
label-download-location = Download-Ordner:
label-queue-transfers = Übertragungen in Warteschlange stellen
label-download-limit = Download-Limit:
label-upload-limit = Upload-Limit:
label-persistent-channels = Permanente Kanäle:
label-auto-join-channels = Auto-Beitritts-Kanäle:
...
permission-news_list = Neuigkeiten Anzeigen
...
permission-voice_listen = Sprache Hören
permission-voice_talk = Sprache Sprechen
permission-group_create = Gruppe Erstellen
permission-group_edit = Gruppe Bearbeiten
permission-group_delete = Gruppe Löschen
...
tooltip-files-download-all = Alles herunterladen
tooltip-upload = Hochladen
file-picker-upload-title = Dateien zum Hochladen auswählen
drop-to-upload = Zum Hochladen ablegen
tooltip-transfers-clear-inactive = Inaktive löschen
tooltip-transfer-pause = Pausieren
tooltip-transfer-resume = Fortsetzen
tooltip-transfer-cancel = Abbrechen
tooltip-transfer-remove = Entfernen
tooltip-transfer-open-folder = Ordner öffnen
tooltip-transfer-move-up = Nach oben
tooltip-transfer-move-down = Nach unten
tooltip-transfer-retry = Erneut versuchen
tooltip-settings = Einstellungen
tooltip-bookmarks-hide = Lesezeichen ausblenden
tooltip-bookmarks-show = Lesezeichen anzeigen
tooltip-user-list-hide = Benutzerliste ausblenden
tooltip-user-list-show = Benutzerliste anzeigen
...
tooltip-server-public-yes = Ja
tooltip-server-public-no = Nein
...
connection-monitor-no-transfers = Keine aktiven Übertragungen

# =============================================================================
# Empty States
# =============================================================================

empty-select-server = Wähle einen Server aus der Liste
empty-no-connections = Keine Verbindungen
empty-no-bookmarks = Keine Lesezeichen
empty-no-users = Keine Benutzer online
empty-no-channel-members = Keine Mitglieder im Kanal
user-management-loading = Benutzer werden geladen…
user-management-no-users = Keine Benutzer gefunden
group-form-name = Name
group-management-no-groups = Keine Gruppen konfiguriert
group-management-loading = Gruppen werden geladen…
group-management-shared = Geteilte Gruppe
user-management-group = Gruppe
...
files-not-found = '{ $name }' nicht gefunden
files-home = Start
...
files-search-query-too-short = Suchanfrage ist zu kurz (min. { $min_length } Bytes)
files-search-query-too-long = Suchanfrage ist zu lang (max. { $max_length } Bytes)
files-search-query-invalid = Suchanfrage enthält ungültige Zeichen
...
err-dir-name-too-long = Verzeichnisname ist zu lang (max. { $max } Bytes)
...
msg-connected-to = Verbunden mit { $server }
msg-server-version = Serverversion: { $version }
msg-logged-in-as = Angemeldet als { $nickname }
msg-logged-in-as-admin = Angemeldet als { $nickname } [Admin]
msg-logged-in-as-shared = Angemeldet als { $nickname } ({ $username })
msg-logged-in-as-shared-admin = Angemeldet als { $nickname } ({ $username }) [Admin]
msg-user-kicked-success = Benutzer erfolgreich gekickt
msg-user-kicked-success-name = Benutzer '{ $nickname }' erfolgreich gekickt
msg-chat-join = { $nickname } ist dem Kanal beigetreten
msg-chat-leave = { $nickname } hat den Kanal verlassen
msg-chat-renamed = { $old } heißt jetzt { $new }
msg-channel-is-secret = Dieser Kanal ist geheim
msg-channel-list-header = Verfügbare Kanäle:
msg-no-channels = Keine Kanäle verfügbar
msg-channel-member-count = { $count } { $count ->
    [one] Mitglied
   *[other] Mitglieder
}
channel-secret = geheim
msg-broadcast-sent = Broadcast erfolgreich gesendet
msg-user-created = Benutzer erfolgreich erstellt
msg-user-created-name = Benutzer '{ $username }' erfolgreich erstellt
...
msg-group-created = Gruppe "{ $name }" erstellt
msg-group-updated = Gruppe "{ $name }" aktualisiert
msg-group-deleted = Gruppe "{ $name }" gelöscht
...
msg-secret-set = Geheimmodus aktiviert von { $username }
...
err-no-certificates-in-chain = Server hat kein Zertifikat vorgelegt.
...
err-user-edit-stale = Dieser Benutzer wurde auf dem Server geändert. Öffnen Sie das Bearbeitungsformular erneut, um vor dem Speichern die neuesten Details zu laden.
...
err-nickname-too-long = Spitzname ist zu lang (max { $max } Zeichen)
err-nickname-invalid = Spitzname enthält ungültige Zeichen
err-password-too-long = Passwort ist zu lang (max { $max } Bytes)
...
err-trust-reason-too-long = Vertrauensgrund ist zu lang (max. { $max } Zeichen)
err-trust-reason-invalid-characters = Vertrauensgrund enthält ungültige Zeichen
...
err-fingerprint-mismatch = Server-Zertifikats-Fingerabdruck hat sich geändert. Prüfe und akzeptiere den neuen Fingerabdruck, um fortzufahren.
err-fingerprint-interception = TLS-Abfangen erkannt. Vom Server gemeldeter Fingerabdruck unterscheidet sich vom beobachteten.
...
user-info-connected-value-sessions = vor { $duration } ({ $count } { $count ->
    [one] Sitzung
   *[other] Sitzungen
})
...
cmd-me-desc = Aktionsnachricht senden (z.B. *** Name winkt)
cmd-me-usage = Verwendung: /{ $command } <aktion>
err-me-no-target = Verwenden Sie /{ $join }, um einem Kanal beizutreten, oder /{ $msg }, um eine Aktion an einen Benutzer zu senden
cmd-message-desc = Nachricht an Benutzer senden
cmd-message-usage = Verwendung: /{ $command } <benutzername> <nachricht>
cmd-ping-desc = Latenz zum Server messen
cmd-ping-usage = Verwendung: /{ $command }
ping-result = Antwort: { $ms }ms
...
cmd-kick-usage = Verwendung: /{ $command } <benutzername> [grund]
...
cmd-focus-desc = Server-Chat, Kanal oder Nachrichtenfenster eines Benutzers fokussieren
cmd-focus-usage = Verwendung: /{ $command } [#kanal|benutzername]
cmd-focus-not-found = Benutzer nicht gefunden: { $name }
cmd-focus-channel-not-joined = Du bist nicht in diesem Kanal: { $channel }
...
cmd-join-desc = Einem Kanal beitreten oder einen erstellen
cmd-join-usage = Verwendung: /{ $command } #kanal
cmd-leave-desc = Einen Kanal verlassen
cmd-leave-usage = Verwendung: /{ $command } [#kanal]
cmd-channels-desc = Verfügbare Kanäle anzeigen
cmd-channels-usage = Verwendung: /{ $command }
cmd-secret-desc = Geheimmodus für aktuellen Kanal umschalten
cmd-secret-usage = Verwendung: /{ $command } [an|aus]
cmd-secret-arg-on = an
cmd-secret-arg-off = aus
err-secret-no-channel = Dieser Befehl funktioniert nur in einem Kanal
err-secret-permission-denied = Sie haben keine Berechtigung, den Geheimmodus des Kanals zu ändern
msg-secret-already-on = Kanal ist bereits geheim
msg-secret-already-off = Kanal ist bereits öffentlich
msg-secret-enabled = Kanal ist jetzt geheim
msg-secret-disabled = Kanal ist jetzt öffentlich
msg-secret-status-on = Dieser Kanal ist geheim
msg-secret-status-off = Dieser Kanal ist öffentlich
...
err-public-address-too-long = Die öffentliche Adresse ist zu lang (maximal { $max } Bytes)
...
err-server-address-empty = Serveradresse ist erforderlich
err-server-address-too-long = Die Serveradresse ist zu lang (maximal { $max } Bytes)
err-server-address-contains-scheme = Die Serveradresse darf kein URL-Schema enthalten
err-server-address-contains-path = Die Serveradresse darf keinen Pfad enthalten
err-server-address-contains-userinfo = Die Serveradresse darf keinen Benutzernamen enthalten
err-server-address-contains-whitespace = Die Serveradresse darf keine Leerzeichen enthalten
err-server-address-contains-port = Die Serveradresse darf keinen Port enthalten
err-server-address-invalid-format = Die Serveradresse ist kein gültiger Hostname oder keine gültige IP-Adresse
...
err-group-name-too-long = Gruppenname überschreitet maximale Länge ({ $max } Zeichen)
...
err-group-shared-mismatch = Geteilte Konten können nur geteilten Gruppen zugewiesen werden
err-group-shared-permission = Geteilte Gruppen können diese Berechtigung nicht haben
err-group-not-empty-delete = Gruppe kann nicht gelöscht werden, solange Benutzer zugewiesen sind
err-group-not-empty-modify = Geteilter Status kann nicht geändert werden, solange Benutzer zugewiesen sind

# Proxy errors
err-proxy-connection-failed = Verbindung zum Proxy fehlgeschlagen: { $error }
err-proxy-connection-timeout = Proxy-Verbindung nach { $seconds } { $seconds ->
    [one] Sekunde
   *[other] Sekunden
} abgelaufen
...
err-topic-no-channel = Dieser Befehl funktioniert nur in einem Kanal
err-join-channel = Fehler beim Beitreten des Kanals: { $error }
err-leave-channel = Fehler beim Verlassen des Kanals: { $error }
err-list-channels = Fehler beim Auflisten der Kanäle: { $error }
err-channel-empty = Der Kanalname darf nicht leer sein
err-channel-too-short = Der Kanalname muss mindestens ein Zeichen nach # haben
err-channel-too-long = Der Kanalname ist zu lang (max. { $max } Zeichen)
err-channel-missing-prefix = Der Kanalname muss mit # beginnen
err-channel-invalid-characters = Der Kanalname enthält ungültige Zeichen
err-leave-no-channel = Du musst in einem Kanal sein, um /{ $command } ohne Argumente zu verwenden
err-not-in-channel = Du bist nicht im Kanal { $channel }
err-leave-already-pending = Warte bereits auf Serverantwort
err-uri-connection-failed = Verbindung zu { $host } fehlgeschlagen: { $error }
...
event-chat-message = Chat-Nachricht
event-chat-mention = Chat-Erwähnung
event-connection-lost = Verbindung verloren
event-news-post = Neuigkeiten
event-permissions-changed = Berechtigungen geändert
event-transfer-complete = Übertragung abgeschlossen
...
event-voice-left = Sprachchat verlassen
event-chat-join = Chat-Beitritt
event-chat-leave = Chat-Austritt

# Notification content levels
notification-content-simple = Einfach
notification-content-compact = Kompakt
notification-content-detailed = Detailliert

# Event settings labels
event-settings-event = Ereignis:
event-settings-notification = Benachrichtigung
event-settings-show-notification = Benachrichtigung anzeigen
event-settings-content = Inhalt:
...
notification-broadcast-from = Broadcast von {$username}
notification-chat-mention = Sie wurden erwähnt
notification-chat-mention-by = Erwähnt von {$username}
notification-chat-message = Neue Chat-Nachricht
notification-chat-message-from = Chat von {$username}
notification-connection-lost = Verbindung verloren
notification-connection-lost-from = Verbindung zu {$server} getrennt
notification-download-complete = Download abgeschlossen
notification-download-failed = Download fehlgeschlagen
notification-news-post = Neue Neuigkeit
notification-news-post-by = Neuigkeit von {$username}
notification-permissions-changed = Berechtigungen geändert
notification-permissions-changed-on = Berechtigungen auf {$server} geändert
notification-transfer-complete = Übertragung abgeschlossen
notification-transfer-failed = Übertragung fehlgeschlagen
notification-upload-complete = Upload abgeschlossen
notification-upload-failed = Upload fehlgeschlagen
notification-user-connected = Benutzer verbunden
...
notification-user-message-from = Nachricht von {$username}
notification-voice-joined = Benutzer ist dem Sprachchat beigetreten
notification-voice-joined-details = {$username} ist dem Sprachchat in {$target} beigetreten
notification-voice-joined-user = {$username} ist dem Sprachchat beigetreten
notification-voice-left = Benutzer hat den Sprachchat verlassen
notification-voice-left-details = {$username} hat den Sprachchat in {$target} verlassen
notification-voice-left-user = {$username} hat den Sprachchat verlassen
notification-chat-join = Benutzer ist dem Kanal beigetreten
notification-chat-join-details = {$username} ist {$channel} beigetreten
notification-chat-leave = Benutzer hat den Kanal verlassen
notification-chat-leave-details = {$username} hat {$channel} verlassen
...
title-user-disconnect-name = { $nickname } trennen
disconnect-action-kick = Kicken
disconnect-action-ban = Sperren
disconnect-duration-label = Dauer:
disconnect-reason-label = Grund:
disconnect-reason-placeholder = Optionaler Grund
button-kick = Kicken
button-ban = Sperren

# Ban duration options
ban-duration-10m = 10 Minuten
ban-duration-1h = 1 Stunde
ban-duration-1d = 1 Tag
ban-duration-7d = 7 Tage
ban-duration-30d = 30 Tage
ban-duration-permanent = Dauerhaft
...
msg-banned-ips-nickname = { $count } { $count ->
    [one] IP ({ $nickname }) gesperrt
   *[other] IPs ({ $nickname }) gesperrt
}
...
msg-unbanned-ips = { $count } { $count ->
    [one] IP-Sperre aufgehoben
   *[other] IP-Sperren aufgehoben
}
msg-unbanned-ips-nickname = { $count } { $count ->
    [one] IP-Sperre ({ $nickname }) aufgehoben
   *[other] IP-Sperren ({ $nickname }) aufgehoben
}
...
msg-trusted-ips-nickname = { $count } { $count ->
    [one] IP ({ $nickname }) vertraut
   *[other] IPs ({ $nickname }) vertraut
}
...
msg-untrusted-ips = { $count } { $count ->
    [one] IP nicht mehr vertraut
   *[other] IPs nicht mehr vertraut
}
msg-untrusted-ips-nickname = { $count } { $count ->
    [one] IP ({ $nickname }) nicht mehr vertraut
   *[other] IPs ({ $nickname }) nicht mehr vertraut
}
...
err-voice-join = Sprachchat beitreten fehlgeschlagen: { $error }
...
err-voice-proxy-not-supported = Voice-Chat ist bei Verwendung eines Proxys blockiert. Aktiviere „Sprach-Bypass zulassen" unter Einstellungen > Netzwerk.
...
msg-voice-joined = Sprachchat in { $target } beigetreten ({ $count } { $count ->
    [one] anderer
   *[other] andere
})
msg-voice-joined-empty = Sprachchat in { $target } beigetreten
...
toast-link-copied = Link kopiert
...
title-tracker-edit = Tracker bearbeiten
title-fingerprint-accept = Fingerabdruck akzeptieren

# Labels
label-address = Adresse:
label-tracker-password = Passwort:
label-fingerprint-unpinned = (nicht angeheftet)

# Placeholders
placeholder-tracker-name = Tracker-Name
placeholder-tracker-address = tracker.example.com
placeholder-tracker-fingerprint = SHA-256-Fingerabdruck (optional)
placeholder-tracker-password = Passwort (optional)

# Tooltips
tooltip-tracker-add = Tracker hinzufügen
tooltip-tracker-connected = Verbunden
tooltip-tracker-disconnected = Getrennt
tooltip-tracker-fingerprint-pending = Fingerabdruck-Konflikt
...
tracker-management-loading = Tracker werden geladen…
tracker-management-no-trackers = Keine Tracker konfiguriert

# Dialog
dialog-remove-tracker-title = Tracker entfernen
dialog-remove-tracker-body = Möchtest du den Tracker „{ $name }“ wirklich entfernen? Die Server-Registrierung wird nicht mehr an diesen Tracker übermittelt. Der Eintrag kann später wieder hinzugefügt werden.
tracker-fingerprint-warning = Der Tracker hat einen neuen Zertifikats-Fingerabdruck präsentiert. Verifiziere ihn über einen vertrauenswürdigen Kanal (Website des Tracker-Betreibers, signierte Ankündigung usw.) bevor du akzeptierst. Beim Akzeptieren wird der neue Fingerabdruck zum angehefteten Wert dieses Servers.

# Toasts
toast-fingerprint-copied = Fingerabdruck kopiert
toast-tracker-added = Tracker hinzugefügt
toast-tracker-added-name = Tracker „{ $name }“ hinzugefügt
toast-tracker-updated = Tracker aktualisiert
toast-tracker-updated-name = Tracker „{ $name }“ aktualisiert
toast-tracker-removed = Tracker entfernt
toast-tracker-removed-name = Tracker „{ $name }“ entfernt
...
err-tracker-address-too-long = Die Tracker-Adresse ist zu lang (maximal { $max } Bytes)
err-tracker-address-contains-scheme = Die Tracker-Adresse darf kein URL-Schema enthalten
err-tracker-address-contains-brackets = Die Tracker-Adresse darf keine Klammern enthalten
err-tracker-address-contains-path = Die Tracker-Adresse darf keinen Pfad enthalten
err-tracker-address-contains-userinfo = Die Tracker-Adresse darf keinen Benutzernamen enthalten
err-tracker-address-contains-whitespace = Die Tracker-Adresse darf keine Leerzeichen enthalten
err-tracker-address-contains-port = Die Tracker-Adresse darf keinen Port enthalten
err-tracker-address-contains-zone-id = Die Tracker-Adresse darf keine IPv6-Zonenkennung enthalten
err-tracker-address-invalid-format = Die Tracker-Adresse ist kein gültiger Hostname oder keine gültige IP-Adresse
err-tracker-fingerprint-invalid = Fingerabdruck muss aus 32 Hex-Paaren in Großbuchstaben mit Doppelpunkten bestehen (95 Zeichen)
err-tracker-name-duplicate = Ein Tracker mit dem Namen „{ $name }" existiert bereits.
tooltip-tracker-browser = Tracker
title-trackers = Tracker
tooltip-tracker-edit = Tracker bearbeiten
tooltip-tracker-remove = Tracker entfernen
...
err-tracker-query-unreachable = Tracker nicht erreichbar: Er ist möglicherweise offline oder die Adresse ist falsch.
err-tracker-query-refused = Tracker hat die Verbindung abgelehnt: Er begrenzt möglicherweise die Anfragerate deiner IP oder ist nicht verfügbar.
...
err-tracker-query-invalid = Tracker hat die Anfrage abgelehnt: ungültige Eingabe.
err-tracker-query-rejected = Tracker hat die Anfrage abgelehnt: { $message }
err-tracker-address-duplicate = Ein Tracker mit dieser Adresse und diesem Port existiert bereits.
err-tracker-password-too-long = Tracker-Passwort ist zu lang (max { $max } Bytes)
err-tracker-add-failed = Tracker konnte nicht hinzugefügt werden
err-tracker-update-failed = Tracker konnte nicht aktualisiert werden
err-tracker-remove-failed = Tracker konnte nicht entfernt werden
err-tracker-accept-fingerprint-failed = Fingerabdruck konnte nicht akzeptiert werden
err-tracker-edit-no-payload = Server hat keine Tracker-Details geliefert

# Permissions (rendered in User/Group edit forms)
permission-tracker_list = Trackerliste
permission-tracker_add = Tracker Hinzufügen
permission-tracker_edit = Tracker Bearbeiten
permission-tracker_remove = Tracker Entfernen

label-bandwidth-section = Bandbreite
label-bandwidth-weight = Bandbreitengewicht:
label-chat-section = Chat
label-files-section = Dateien
label-general-section = Allgemein
label-inherit-bandwidth-weight = Bandbreitengewicht erben
