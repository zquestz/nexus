...
title-add-server = Server hinzufügen
...
placeholder-server-name-optional = Servername (optional)
placeholder-server-address = Server-IPv6-Adresse
placeholder-server-name = Servername
placeholder-ipv6-address = IPv6-Adresse
...
msg-username-error = Fehler
msg-username-info = Info
msg-username-broadcast-prefix = [RUNDNACHRICHT]
