...
files-search-query-too-short = Zoekopdracht is te kort (min. { $min_length } tekens)
files-search-query-too-long = Zoekopdracht is te lang (max. { $max_length } tekens)
...
err-duration-too-long = Duur is te lang (max { $max } tekens)
