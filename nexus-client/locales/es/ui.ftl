...
button-add-bookmark = Añadir Marcador
...
placeholder-server-name-optional = Nombre del Servidor (opcional)
placeholder-server-address = Dirección IPv6 del Servidor
placeholder-server-name = Nombre del Servidor
placeholder-ipv6-address = Dirección IPv6
