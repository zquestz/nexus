...
button-create = Crear
button-edit = Editar
button-accept-new-certificate = Aceptar
button-close = Cerrar
...
title-bookmark-create = Crear Marcador
title-bookmark-edit = Editar Marcador
title-broadcast-message = Difusión
title-user-create = Crear Usuario
title-user-edit = Editar Usuario
title-user-management = Gestionar Usuarios
title-group-create = Crear Grupo
title-group-edit = Editar Grupo
title-confirm-delete = Confirmar Eliminación
title-connected = Conectados
title-settings = Configuración
title-bookmarks = Marcadores
title-users = Usuarios
title-server-info-edit = Editar Info del Servidor
...
placeholder-password-keep-current = Contraseña
placeholder-current-password = Contraseña Actual
placeholder-new-password = Nueva Contraseña
placeholder-confirm-password = Confirmar Contraseña
placeholder-message = Escribe un mensaje…
placeholder-no-permission = Sin permiso
placeholder-broadcast-message = Mensaje de difusión
...
placeholder-fingerprint = Huella SHA-256 (opcional)
...
placeholder-persistent-channels = #canal1 #canal2 (separados por espacios)
placeholder-auto-join-channels = #canal1 #canal2 (separados por espacios)
...
label-shared-account = Cuenta Compartida
...
chat-history-30-days = 30 días
chat-history-14-days = 14 días
chat-history-7-days = 7 días
chat-history-disabled = Desactivado
label-auto-away = Auto-Ausente:
label-auto-away-message = Mensaje de Auto-Ausente:
auto-away-off = Desactivado
auto-away-5min = 5 Minutos
auto-away-10min = 10 Minutos
auto-away-15min = 15 Minutos
auto-away-30min = 30 Minutos
...
label-max-transfers-per-ip = Máx. Transferencias Por IP:
label-file-reindex-interval = Intervalo de Reindexación:
...
label-avatar = Icono:
label-server-image = Imagen del servidor:
label-details = Detalles técnicos
label-chat-options = Opciones de chat
label-appearance = Apariencia
label-image = Imagen
label-general = General
label-limits = Límites
label-news-body = Cuerpo:
label-news-image = Imagen:
label-identity = Identidad
...
label-log-level = Nivel de Log:
label-log-level-none = Ninguno
label-log-level-error = Error
label-log-level-warn = Advertencia
...
label-public-address = Dirección pública:
...
label-allow-voice-bypass = Permitir omisión de voz
label-download-location = Ubicación de Descarga:
label-queue-transfers = Poner Transferencias en Cola
label-download-limit = Límite de Descargas:
label-upload-limit = Límite de Subidas:
label-persistent-channels = Canales Persistentes:
label-auto-join-channels = Canales Auto-Unión:
...
permission-chat_join = Unirse al Chat
permission-chat_create = Crear Chat
permission-chat_list = Lista de Chats
...
permission-voice_listen = Escuchar Voz
permission-voice_talk = Hablar por Voz
permission-group_create = Crear Grupo
permission-group_edit = Editar Grupo
permission-group_delete = Eliminar Grupo
...
tooltip-files-home = Ir a Inicio
tooltip-files-go-root = Ir a Raíz
tooltip-files-refresh = Actualizar
tooltip-files-view-root = Ver Raíz
tooltip-files-view-home = Ver Inicio
tooltip-files-show-hidden = Mostrar Archivos Ocultos
tooltip-files-hide-hidden = Ocultar Archivos Ocultos
tooltip-files-new-directory = Nuevo Directorio
...
tooltip-files-download-all = Descargar Todo
tooltip-upload = Subir
file-picker-upload-title = Seleccionar archivos para subir
drop-to-upload = Soltar para subir
tooltip-transfers-clear-inactive = Limpiar Inactivos
tooltip-transfer-pause = Pausar
tooltip-transfer-resume = Reanudar
tooltip-transfer-cancel = Cancelar
tooltip-transfer-remove = Eliminar
tooltip-transfer-open-folder = Abrir Carpeta
tooltip-transfer-move-up = Subir
tooltip-transfer-move-down = Bajar
tooltip-transfer-retry = Reintentar
tooltip-settings = Configuración
tooltip-bookmarks-hide = Ocultar Marcadores
tooltip-bookmarks-show = Mostrar Marcadores
tooltip-user-list-hide = Ocultar Lista de Usuarios
tooltip-user-list-show = Mostrar Lista de Usuarios
...
connection-monitor-no-transfers = Sin transferencias activas
...
empty-no-channel-members = No hay miembros en el canal
user-management-loading = Cargando usuarios…
user-management-no-users = No se encontraron usuarios
group-form-name = Nombre
group-management-no-groups = No hay grupos configurados
group-management-loading = Cargando grupos…
group-management-shared = Grupo Compartido
user-management-group = Grupo
user-management-group-none = Ninguno
news-loading = Cargando noticias…
news-no-posts = Aún no hay publicaciones
news-author-deleted = <Usuario eliminado>
...
files-column-path = Ruta
files-search-placeholder = Buscar archivos…
files-search-breadcrumb = Búsqueda - { $query }
files-searching = Buscando…
files-no-results = No se encontraron archivos
files-search-query-too-short = La consulta de búsqueda es muy corta (mín. { $min_length } bytes)
files-search-query-too-long = La consulta de búsqueda es muy larga (máx. { $max_length } bytes)
files-search-query-invalid = La consulta de búsqueda contiene caracteres no válidos
...
files-overwrite-title = El archivo ya existe
files-overwrite-message = Ya existe un archivo o carpeta llamado "{ $name }" en el destino. ¿Desea reemplazarlo?
...
err-dir-name-too-long = El nombre del directorio es demasiado largo (máx. { $max } bytes)
...
msg-server-version = Versión del servidor: { $version }
...
msg-user-kicked-success-name = Usuario '{ $nickname }' expulsado exitosamente
msg-chat-join = { $nickname } se unió al canal
msg-chat-leave = { $nickname } abandonó el canal
msg-chat-renamed = { $old } ahora se conoce como { $new }
msg-channel-is-secret = Este canal es secreto
msg-channel-list-header = Canales disponibles:
msg-no-channels = No hay canales disponibles
...
msg-user-created-name = Usuario '{ $username }' creado exitosamente
msg-user-deleted = Usuario eliminado exitosamente
msg-user-deleted-name = Usuario '{ $username }' eliminado exitosamente
...
msg-group-created = Grupo "{ $name }" creado
msg-group-updated = Grupo "{ $name }" actualizado
msg-group-deleted = Grupo "{ $name }" eliminado
...
err-no-certificates-in-chain = El servidor no presentó ningún certificado.
...
err-user-edit-stale = Este usuario se modificó en el servidor. Vuelve a abrir el formulario de edición para cargar los datos más recientes antes de guardar.
...
err-nickname-too-long = El apodo es demasiado largo (máx { $max } caracteres)
err-nickname-invalid = El apodo contiene caracteres inválidos
err-password-too-long = La contraseña es demasiado larga (máx { $max } bytes)
err-passwords-do-not-match = Las contraseñas no coinciden
...
err-trust-reason-too-long = El motivo de confianza es demasiado largo (máx. { $max } caracteres)
err-trust-reason-invalid-characters = El motivo de confianza contiene caracteres inválidos
...
err-fingerprint-mismatch = La huella del certificado del servidor cambió. Revisa y acepta la nueva huella para continuar.
err-fingerprint-interception = Interceptación TLS detectada. La huella reportada por el servidor difiere de la observada.
...
user-info-role-guest = invitado
user-info-role-shared = compartido
user-info-role-user = usuario
user-info-group = Grupo:
user-info-nickname = Apodo:
user-info-account = Cuenta: { $username }
user-info-connected = Conectado:
user-info-connected-value = hace { $duration }
user-info-connected-value-sessions = hace { $duration } ({ $count } { $count ->
    [one] sesión
   *[other] sesiones
})
...
cmd-ping-desc = Medir latencia al servidor
cmd-ping-usage = Uso: /{ $command }
ping-result = Respuesta: { $ms }ms
...
cmd-kick-usage = Uso: /{ $command } <usuario> [razón]
...
cmd-focus-desc = Enfocar chat del servidor, canal o ventana de mensajes de un usuario
cmd-focus-usage = Uso: /{ $command } [#canal|usuario]
cmd-focus-not-found = Usuario no encontrado: { $name }
cmd-focus-channel-not-joined = No estás en el canal: { $channel }
...
cmd-reindex-desc = Activar reconstrucción del índice de archivos
cmd-reindex-usage = Uso: /{ $command }
msg-reindex-triggered = Reconstrucción del índice de archivos activada
cmd-join-desc = Unirse o crear un canal
cmd-join-usage = Uso: /{ $command } #canal
cmd-leave-desc = Abandonar un canal
cmd-leave-usage = Uso: /{ $command } [#canal]
cmd-channels-desc = Listar canales disponibles
cmd-channels-usage = Uso: /{ $command }
cmd-secret-desc = Alternar modo secreto en el canal actual
cmd-secret-usage = Uso: /{ $command } [on|off]
cmd-secret-arg-on = on
cmd-secret-arg-off = off
err-secret-no-channel = Este comando solo funciona en un canal
err-secret-permission-denied = No tienes permiso para cambiar el modo secreto del canal
msg-secret-already-on = El canal ya es secreto
msg-secret-already-off = El canal ya es público
msg-secret-enabled = El canal ahora es secreto
msg-secret-disabled = El canal ahora es público
msg-secret-status-on = Este canal es secreto
msg-secret-status-off = Este canal es público
cmd-trust-desc = Confiar en una IP, rango CIDR o apodo para evadir baneos
cmd-trust-usage = Uso: /{ $command } <objetivo> [duración] [razón]
cmd-untrust-desc = Eliminar una entrada de IP confiable
cmd-untrust-usage = Uso: /{ $command } <objetivo>
cmd-trusted-desc = Listar IPs confiables
...
err-public-address-too-long = La dirección pública es demasiado larga (máx. { $max } bytes)
...
err-server-address-empty = Se requiere la dirección del servidor
err-server-address-too-long = La dirección del servidor es demasiado larga (máx. { $max } bytes)
err-server-address-contains-scheme = La dirección del servidor no debe incluir un esquema de URL
err-server-address-contains-path = La dirección del servidor no debe incluir una ruta
err-server-address-contains-userinfo = La dirección del servidor no debe incluir un nombre de usuario
err-server-address-contains-whitespace = La dirección del servidor no debe contener espacios en blanco
err-server-address-contains-port = La dirección del servidor no debe incluir un puerto
err-server-address-invalid-format = La dirección del servidor no es un nombre de host o dirección IP válida
...
err-group-name-too-long = El nombre del grupo excede la longitud máxima ({ $max } caracteres)
err-group-name-invalid = El nombre del grupo contiene caracteres no válidos
err-group-not-found = Grupo no encontrado
err-group-already-exists = Ya existe un grupo con este nombre
err-group-shared-mismatch = Las cuentas compartidas solo pueden asignarse a grupos compartidos
...
# Proxy errors
err-proxy-connection-failed = Error al conectar con el proxy: { $error }
err-proxy-connection-timeout = Tiempo de espera del proxy agotado después de { $seconds } { $seconds ->
    [one] segundo
   *[other] segundos
}
err-proxy-address-required = Se requiere la dirección del proxy cuando está habilitado
err-proxy-port-invalid = El puerto del proxy debe estar entre 1 y 65535
...
err-topic-no-channel = Este comando solo funciona en un canal
err-join-channel = Error al unirse al canal: { $error }
err-leave-channel = Error al abandonar el canal: { $error }
err-list-channels = Error al listar canales: { $error }
err-channel-empty = El nombre del canal no puede estar vacío
err-channel-too-short = El nombre del canal debe tener al menos un carácter después de #
...
# Transfer statuses
transfer-status-queued = En cola
transfer-status-connecting = Conectando…
transfer-status-transferring = Transfiriendo
transfer-status-paused = Pausado
transfer-status-completed = Completado
transfer-status-failed = Fallido

# Transfer actions
transfer-action-pause = Pausar
transfer-action-resume = Reanudar
transfer-action-cancel = Cancelar
transfer-action-remove = Eliminar
...
event-chat-message = Mensaje de chat
event-chat-mention = Mención en chat
event-connection-lost = Conexión perdida
event-news-post = Publicación de noticias
event-permissions-changed = Permisos cambiados
event-transfer-complete = Transferencia completada
event-transfer-failed = Transferencia fallida
event-user-connected = Usuario conectado
event-user-disconnected = Usuario desconectado
event-user-banned = Usuario baneado
event-user-kicked = Usuario expulsado
event-user-message = Mensaje de usuario
event-voice-joined = Usuario entró al chat de voz
event-voice-left = Usuario salió del chat de voz
event-chat-join = Entrada al chat
event-chat-leave = Salida del chat

# Notification content levels
notification-content-simple = Simple
notification-content-compact = Compacto
notification-content-detailed = Detallado

# Event settings labels
event-settings-event = Evento:
event-settings-notification = Notificación
event-settings-show-notification = Mostrar notificación
event-settings-content = Contenido:
settings-notifications-enabled = Activar notificaciones

# Sound settings
settings-sound-enabled = Activar sonido
settings-sound-volume = Volumen:
settings-sound-play = Reproducir sonido
settings-sound-always-play = Reproducir siempre
settings-sound-test = Probar
settings-notification-test = Probar
event-settings-show-toast = Mostrar Toast
settings-toast-test = Probar
...
notification-broadcast = Difusión del servidor
notification-broadcast-from = Difusión de {$username}
notification-chat-mention = Te han mencionado
notification-chat-mention-by = Mencionado por {$username}
notification-chat-message = Nuevo mensaje de chat
notification-chat-message-from = Chat de {$username}
notification-connection-lost = Conexión perdida
notification-connection-lost-from = Desconectado de {$server}
notification-download-complete = Descarga completada
notification-download-failed = Descarga fallida
notification-news-post = Nueva publicación de noticias
notification-news-post-by = Publicación de {$username}
notification-permissions-changed = Permisos cambiados
notification-permissions-changed-on = Permisos cambiados en {$server}
notification-transfer-complete = Transferencia completada
notification-transfer-failed = Transferencia fallida
notification-upload-complete = Subida completada
notification-upload-failed = Subida fallida
notification-user-connected = Usuario conectado
notification-user-connected-name = {$username} conectado
notification-user-disconnected = Usuario desconectado
notification-user-disconnected-name = {$username} desconectado
notification-user-banned = Has sido baneado
notification-user-banned-from = Baneado de {$server}
notification-user-kicked = Has sido expulsado
notification-user-kicked-from = Expulsado de {$server}
notification-user-message = Nuevo mensaje de usuario
notification-user-message-from = Mensaje de {$username}
notification-voice-joined = Usuario entró al chat de voz
notification-voice-joined-details = {$username} entró al chat de voz en {$target}
notification-voice-joined-user = {$username} entró al chat de voz
notification-voice-left = Usuario salió del chat de voz
notification-voice-left-details = {$username} salió del chat de voz en {$target}
notification-voice-left-user = {$username} salió del chat de voz
notification-chat-join = Usuario unido al canal
notification-chat-join-details = {$username} se unió a {$channel}
notification-chat-leave = Usuario abandonó el canal
notification-chat-leave-details = {$username} abandonó {$channel}
...
title-user-disconnect-name = Desconectar { $nickname }
disconnect-action-kick = Expulsar
disconnect-action-ban = Banear
disconnect-duration-label = Duración:
disconnect-reason-label = Razón:
disconnect-reason-placeholder = Razón opcional
button-kick = Expulsar
button-ban = Banear

# Ban duration options
ban-duration-10m = 10 minutos
...
# Trust list messages
msg-trust-list-header = IPs confiables:
msg-trust-list-empty = No hay IPs confiables
msg-trust-permanent = permanente
msg-trust-expired = expirado
msg-trust-remaining = { $time } restante
...
err-voice-ptt-failed = No se pudo registrar la tecla de pulsar para hablar: { $error }
err-voice-proxy-not-supported = El chat de voz está bloqueado al usar un proxy. Activa «Permitir omisión de voz» en Configuración > Red.
err-ptt-init-failed = Sistema PTT no disponible
warn-voice-processor-disabled = Procesamiento de audio desactivado: { $error }
warn-voice-quality-failed = Error al cambiar la calidad de voz: { $error }

# Voice success messages
msg-voice-joined = Te uniste al chat de voz en { $target } ({ $count } { $count ->
    [one] otro
   *[other] otros
})
...
audio-ptt-release-delay = Retardo de liberación PTT:
...
noise-level-off = Desactivado
noise-level-low = Bajo
noise-level-moderate = Moderado
noise-level-high = Alto
noise-level-very-high = Muy alto
...
audio-mic-boost = Amplificación del micrófono:
mic-boost-off = Desactivado
mic-boost-6db = +6 dB
...
settings-minimize-to-tray = Minimizar a la bandeja

# Rendering
settings-hardware-rendering = Renderizado por hardware
...
toast-download-started = Descargando { $filename }
toast-download-queued = Descarga en cola: { $filename }
toast-download-invalid-name = No se puede descargar: nombre de archivo o carpeta inválido.
toast-upload-started = Subiendo { $filename }
toast-upload-queued = Subida en cola: { $filename }
toast-uploads-started = Subiendo { $count } { $count ->
    [one] archivo
   *[other] archivos
}
...
title-fingerprint-accept = Aceptar huella

# Labels
label-address = Dirección:
label-tracker-password = Contraseña:
label-fingerprint-unpinned = (no fijada)

# Placeholders
placeholder-tracker-name = Nombre del tracker
placeholder-tracker-address = tracker.example.com
placeholder-tracker-fingerprint = Huella SHA-256 (opcional)
placeholder-tracker-password = Contraseña (opcional)

# Tooltips
tooltip-tracker-add = Agregar tracker
tooltip-tracker-connected = Conectado
tooltip-tracker-disconnected = Desconectado
tooltip-tracker-fingerprint-pending = Huella No Coincide
...
tracker-management-loading = Cargando trackers…
tracker-management-no-trackers = No hay trackers configurados

# Dialog
dialog-remove-tracker-title = Quitar tracker
dialog-remove-tracker-body = ¿Seguro que quieres quitar el tracker «{ $name }»? Tu servidor dejará de publicar el registro en este tracker. Puedes volver a agregarlo más tarde.
tracker-fingerprint-warning = El tracker presentó una nueva huella de certificado. Verifícala por un canal de confianza (sitio del operador, anuncio firmado, etc.) antes de aceptar. Al aceptar, la nueva huella reemplazará a la anclada para este servidor.

# Toasts
toast-fingerprint-copied = Huella copiada
toast-tracker-added = Tracker agregado
toast-tracker-added-name = Tracker «{ $name }» agregado
toast-tracker-updated = Tracker actualizado
toast-tracker-updated-name = Tracker «{ $name }» actualizado
toast-tracker-removed = Tracker eliminado
toast-tracker-removed-name = Tracker «{ $name }» eliminado
...
err-tracker-address-too-long = La dirección del tracker es demasiado larga (máx. { $max } bytes)
err-tracker-address-contains-scheme = La dirección del tracker no debe incluir un esquema de URL
err-tracker-address-contains-brackets = La dirección del tracker no debe incluir corchetes
err-tracker-address-contains-path = La dirección del tracker no debe incluir una ruta
err-tracker-address-contains-userinfo = La dirección del tracker no debe incluir un nombre de usuario
err-tracker-address-contains-whitespace = La dirección del tracker no debe contener espacios en blanco
err-tracker-address-contains-port = La dirección del tracker no debe incluir un puerto
err-tracker-address-contains-zone-id = La dirección del tracker no debe incluir un identificador de zona IPv6
err-tracker-address-invalid-format = La dirección del tracker no es un nombre de host o dirección IP válida
err-tracker-fingerprint-invalid = La huella debe ser 32 pares hex en mayúsculas separados por dos puntos (95 caracteres)
err-tracker-name-duplicate = Ya existe un tracker llamado "{ $name }".
tooltip-tracker-browser = Trackers
title-trackers = Trackers
tooltip-tracker-edit = Editar tracker
tooltip-tracker-remove = Quitar tracker
...
err-tracker-query-unreachable = Tracker inaccesible: puede estar caído o la dirección puede ser incorrecta.
err-tracker-query-refused = El tracker rechazó la conexión: puede estar limitando la velocidad de tu IP o no estar disponible.
...
err-tracker-fingerprint-save-failed = No se pudo guardar la huella del tracker: { $error }
...
err-tracker-query-invalid = El tracker rechazó la solicitud: entrada no válida.
err-tracker-query-rejected = El tracker rechazó la solicitud: { $message }
err-tracker-address-duplicate = Ya existe un tracker en esta dirección y puerto.
err-tracker-password-too-long = La contraseña del tracker es demasiado larga (máx { $max } bytes)
err-tracker-add-failed = No se pudo agregar el tracker
err-tracker-update-failed = No se pudo actualizar el tracker
err-tracker-remove-failed = No se pudo quitar el tracker
err-tracker-accept-fingerprint-failed = No se pudo aceptar la huella
err-tracker-edit-no-payload = El servidor no devolvió detalles del tracker

# Permissions
permission-tracker_list = Lista de Trackers
permission-tracker_add = Agregar Tracker
...
err-frame-payload-allocation-failed = La longitud de la carga { $length } es demasiado grande para asignarla para { $message_type }
