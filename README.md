...
[![Version](https://img.shields.io/badge/version-0.9.11-blue.svg)](https://github.com/zquestz/nexus)
...
- **Chat** — Real-time messaging with channels, user messages, broadcasts, text selection, and persistent message history
...
| Windows (arm64)   | `nexus-client-{version}-windows-arm64.msi`                                                                                                 |
