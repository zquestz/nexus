...
err-cannot-reset-privileged-password = No puedes restablecer la contraseña de un usuario que tiene permisos que tú no tienes
...
err-server-image-undecodable = La imagen del servidor no se pudo decodificar como una imagen válida
...
err-news-image-undecodable = La imagen de la noticia no se pudo decodificar como una imagen válida
