...
err-status-too-long = Le message d'absence est trop long (max. { $max_length } octets)
...
err-broadcast-too-long = Message trop long (maximum { $max_length } octets)
err-chat-too-long = Message trop long (maximum { $max_length } octets)
err-topic-too-long = Le sujet ne peut pas dépasser { $max_length } octets
...
err-server-name-too-long = Le nom du serveur est trop long (maximum { $max_length } octets)
...
err-server-description-too-long = La description du serveur est trop longue (maximum { $max_length } octets)
...
err-address-too-long = L'adresse est trop longue (maximum { $max_length } octets)
err-address-contains-scheme = L'adresse ne doit pas inclure de schéma d'URL
err-address-contains-brackets = L'adresse ne doit pas inclure de crochets
err-address-contains-path = L'adresse ne doit pas inclure de chemin
err-address-contains-userinfo = L'adresse ne doit pas inclure de nom d'utilisateur
err-address-contains-whitespace = L'adresse ne doit pas contenir d'espaces
err-address-contains-port = L'adresse ne doit pas inclure de port
err-address-contains-zone-id = L'adresse ne doit pas inclure d'identifiant de zone IPv6
err-address-invalid-format = L'adresse n'est pas un nom d'hôte ou une adresse IP valide
err-address-empty = L'adresse ne peut pas être vide

# Erreurs de news
err-news-not-found = Article #{ $id } introuvable
err-news-body-too-long = Le contenu de l'article est trop long (maximum { $max_length } octets)
...
err-tracker-name-too-long = Le nom du tracker est trop long (max { $max_length } octets)
