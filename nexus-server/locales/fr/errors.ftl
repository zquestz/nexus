...
err-cannot-reset-privileged-password = Vous ne pouvez pas réinitialiser le mot de passe d'un utilisateur possédant des permissions que vous n'avez pas
...
duration-remaining-days = { $days }j { $hours }h
