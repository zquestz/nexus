...
err-address-too-long = O endereço é demasiado longo (máximo { $max_length } bytes)
err-address-contains-scheme = O endereço não pode incluir um esquema de URL
err-address-contains-brackets = O endereço não pode incluir parênteses retos
err-address-contains-path = O endereço não pode incluir um caminho
err-address-contains-userinfo = O endereço não pode incluir um nome de utilizador
...
err-address-invalid-format = O endereço não é um nome de anfitrião ou endereço IP válido
