...
err-address-too-long = アドレスが長すぎます（最大{ $max_length }バイト）
err-address-contains-scheme = アドレスにURLスキームを含めることはできません
err-address-contains-brackets = アドレスに角括弧を含めることはできません
err-address-contains-path = アドレスにパスを含めることはできません
err-address-contains-userinfo = アドレスにユーザー名を含めることはできません
err-address-contains-whitespace = アドレスに空白を含めることはできません
err-address-contains-port = アドレスにポートを含めることはできません
err-address-contains-zone-id = アドレスにIPv6ゾーン識別子を含めることはできません
err-address-invalid-format = アドレスは有効なホスト名またはIPアドレスではありません
err-address-empty = アドレスを空にすることはできません
