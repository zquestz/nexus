...
err-address-too-long = 주소가 너무 깁니다 (최대 { $max_length } 바이트)
err-address-contains-scheme = 주소에는 URL 스킴을 포함할 수 없습니다
err-address-contains-brackets = 주소에는 대괄호를 포함할 수 없습니다
err-address-contains-path = 주소에는 경로를 포함할 수 없습니다
err-address-contains-userinfo = 주소에는 사용자 이름을 포함할 수 없습니다
err-address-contains-whitespace = 주소에는 공백을 포함할 수 없습니다
err-address-contains-port = 주소에는 포트를 포함할 수 없습니다
err-address-contains-zone-id = 주소에는 IPv6 영역 식별자를 포함할 수 없습니다
err-address-invalid-format = 주소가 유효한 호스트 이름 또는 IP 주소가 아닙니다
err-address-empty = 주소는 비워둘 수 없습니다
