...
err-address-too-long = Die Adresse ist zu lang (maximal { $max_length } Bytes)
err-address-contains-scheme = Die Adresse darf kein URL-Schema enthalten
err-address-contains-brackets = Die Adresse darf keine Klammern enthalten
err-address-contains-path = Die Adresse darf keinen Pfad enthalten
err-address-contains-userinfo = Die Adresse darf keinen Benutzernamen enthalten
err-address-contains-whitespace = Die Adresse darf keine Leerzeichen enthalten
err-address-contains-port = Die Adresse darf keinen Port enthalten
err-address-contains-zone-id = Die Adresse darf keine IPv6-Zonenkennung enthalten
err-address-invalid-format = Die Adresse ist kein gültiger Hostname oder keine gültige IP-Adresse
err-address-empty = Adresse darf nicht leer sein
