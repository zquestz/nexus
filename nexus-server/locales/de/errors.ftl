...
err-nickname-unavailable = Spitzname ist nicht verfügbar
...
err-login-rate-limited = Zu viele fehlgeschlagene Anmeldeversuche. Versuchen Sie es später erneut.
...
err-cannot-reset-privileged-password = Sie können das Passwort eines Benutzers, der Berechtigungen besitzt, die Sie nicht haben, nicht zurücksetzen
...
duration-remaining-days = { $days }T { $hours }Std
duration-remaining-hours = { $hours }Std { $minutes }Min
duration-remaining-minutes = { $minutes }Min
