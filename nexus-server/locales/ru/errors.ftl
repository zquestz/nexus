...
err-nickname-unavailable = Псевдоним недоступен
...
err-permission-denied-chat-create = Доступ запрещен: вы можете присоединяться к существующим каналам, но не можете создавать новые
...
err-cannot-reset-privileged-password = Вы не можете сбросить пароль пользователя, имеющего права, которых нет у вас
...
err-personal-file-area-exists = Личная файловая область для "{ $username }" уже существует
err-personal-file-area-migration-failed = Не удалось перенести личную файловую область
err-personal-file-area-busy = Личная файловая область занята
err-personal-file-area-rollback-failed-warning = Не удалось откатить перенос личной файловой области; область может остаться в "{ $new_username }" вместо "{ $old_username }". Проверьте журналы сервера перед повторной попыткой.
...
err-server-image-undecodable = Изображение сервера не удалось декодировать как корректное изображение
...
err-news-image-undecodable = Изображение новости не удалось декодировать как корректное изображение
...
err-slow-client-disconnect = Отключено: ваш клиент не успевал обрабатывать сообщения сервера.
