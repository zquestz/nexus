...
err-address-too-long = L'indirizzo è troppo lungo (massimo { $max_length } byte)
err-address-contains-scheme = L'indirizzo non deve includere uno schema URL
err-address-contains-brackets = L'indirizzo non deve includere parentesi
err-address-contains-path = L'indirizzo non deve includere un percorso
err-address-contains-userinfo = L'indirizzo non deve includere un nome utente
err-address-contains-whitespace = L'indirizzo non deve contenere spazi
err-address-contains-port = L'indirizzo non deve includere una porta
err-address-contains-zone-id = L'indirizzo non deve includere un identificatore di zona IPv6
err-address-invalid-format = L'indirizzo non è un nome host o indirizzo IP valido
err-address-empty = L'indirizzo non può essere vuoto
