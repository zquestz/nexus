...
err-nickname-unavailable = Il soprannome non è disponibile
...
err-avatar-unsupported-type = Tipo di avatar non supportato (solo PNG, JPEG, WebP o SVG)
err-avatar-undecodable = Impossibile decodificare l'avatar come immagine valida
err-authentication = Errore di autenticazione
err-invalid-credentials = Nome utente o password non validi
err-login-rate-limited = Troppi tentativi di accesso falliti. Riprova più tardi.
...
err-permission-denied-chat-create = Permesso negato: puoi unirti ai canali esistenti ma non puoi crearne di nuovi

# Errori di funzionalità
err-chat-feature-not-enabled = La funzionalità chat non è abilitata
err-chat-target-feature-not-enabled = { $nickname } non ha un client compatibile con la chat online

# Errori di canale
err-channel-name-empty = Il nome del canale non può essere vuoto
err-channel-name-too-short = Il nome del canale deve avere almeno un carattere dopo #
err-channel-name-too-long = Il nome del canale è troppo lungo (massimo { $max_length } caratteri)
err-channel-name-invalid = Il nome del canale contiene caratteri non validi
err-channel-name-missing-prefix = Il nome del canale deve iniziare con #
err-channel-not-found = Canale '{ $channel }' non trovato
err-channel-already-member = Sei già membro del canale '{ $channel }'
err-channel-limit-exceeded = Non puoi unirti a più di { $max } canali
err-channel-list-invalid = Canale non valido '{ $channel }': { $reason }
...
err-cannot-reset-privileged-password = Non puoi reimpostare la password di un utente che ha permessi che tu non hai
...
err-kick-reason-too-long = Il motivo dell'espulsione è troppo lungo (max { $max_length } caratteri)
...
err-personal-file-area-exists = L'area file personale per "{ $username }" esiste già
err-personal-file-area-migration-failed = Impossibile migrare l'area file personale
err-personal-file-area-busy = L'area file personale è occupata
err-personal-file-area-rollback-failed-warning = Il ripristino dell'area file personale non è riuscito; l'area potrebbe restare sotto "{ $new_username }" invece di "{ $old_username }". Controlla i log del server prima di riprovare.
...
err-permission-grant-revoke-conflict = Il permesso { $permission } non può essere sia concesso che revocato
...
err-invalid-password-strength = Valore di sicurezza della password non valido
...
err-server-image-unsupported-type = Tipo di immagine del server non supportato (solo PNG, JPEG, WebP o SVG)
err-server-image-undecodable = Impossibile decodificare l'immagine del server come immagine valida
err-public-address-too-long = L'indirizzo pubblico è troppo lungo (massimo { $max_length } byte)
...
err-news-image-unsupported-type = Tipo di immagine della notizia non supportato (solo PNG, JPEG, WebP o SVG)
err-news-image-undecodable = Impossibile decodificare l'immagine della notizia come immagine valida
...
# File Area Errors
err-file-path-too-long = Il percorso del file è troppo lungo (massimo { $max_length } byte)
...
err-dir-name-empty = Il nome della directory non può essere vuoto
err-dir-name-too-long = Il nome della directory è troppo lungo (massimo { $max_length } byte)
err-dir-name-invalid = Il nome della directory contiene caratteri non validi
err-dir-already-exists = Un file o una directory con questo nome esiste già
err-dir-create-failed = Impossibile creare la directory

err-dir-not-empty = La cartella non è vuota
err-delete-failed = Impossibile eliminare il file o la cartella
err-rename-failed = Impossibile rinominare il file o la cartella
err-rename-target-exists = Un file o una directory con questo nome esiste già
err-move-failed = Impossibile spostare il file o la cartella
err-copy-failed = Impossibile copiare il file o la cartella
err-destination-exists = Un file o una directory con questo nome esiste già nella destinazione
...
err-file-area-not-accessible = Area file non accessibile
err-transfer-path-too-long = Il percorso è troppo lungo
err-transfer-path-invalid = Il percorso contiene caratteri non validi
err-transfer-access-denied = Accesso negato
err-transfer-read-failed = Impossibile leggere i file
err-transfer-path-not-found = File o directory non trovato
err-transfer-file-failed = Impossibile trasferire { $path }: { $error }

# Upload Errors
err-upload-destination-not-allowed = La cartella di destinazione non consente caricamenti
err-upload-write-failed = Impossibile scrivere il file
err-upload-insufficient-space = Spazio libero insufficiente per il caricamento
err-upload-hash-mismatch = Verifica del file fallita - hash non corrispondente
err-upload-path-invalid = Percorso file non valido nel caricamento
err-upload-conflict = Un altro caricamento con questo nome file è in corso o è stato interrotto. Prova con un nome file diverso.
err-upload-file-exists = Un file con questo nome esiste già. Scegli un nome file diverso o chiedi a un amministratore di eliminare il file esistente.
err-upload-empty = Il caricamento deve contenere almeno un file
err-upload-protocol-error = Errore di protocollo di caricamento
err-upload-connection-lost = Connessione persa durante il caricamento
...
duration-remaining-days = { $days }g { $hours }h
...
err-search-query-too-long = La query di ricerca è troppo lunga (max { $max_length } byte)
err-search-query-invalid = La query di ricerca contiene caratteri non validi
err-search-failed = Ricerca fallita
# Trust System Errors
err-trust-invalid-target = Destinazione non valida (usa nickname, indirizzo IP o intervallo CIDR)
err-trust-invalid-duration = Formato durata non valido (usa 10m, 4h, 7d, o 0 per permanente)
err-trust-not-found = Nessuna voce attendibile trovata per '{ $target }'

# Voice Errors
err-voice-listen-required = Hai bisogno del permesso voice_listen per unirti alla voce
err-voice-feature-not-enabled = La funzionalità voce non è abilitata
err-voice-already-joined = Sei già in una sessione vocale
err-voice-not-joined = Non sei in una sessione vocale
err-voice-not-channel-member = Devi essere membro di { $channel } per unirti alla voce
err-voice-target-not-online = { $nickname } non è online
err-voice-target-feature-not-enabled = { $nickname } non ha un client compatibile con la voce online
err-voice-invalid-target = Destinazione vocale non valida

# Errori di gruppo
err-group-name-empty = Il nome del gruppo non può essere vuoto
err-group-name-too-long = Il nome del gruppo è troppo lungo (massimo { $max_length } caratteri)
err-group-name-invalid = Il nome del gruppo contiene caratteri non validi
err-group-not-found = Gruppo non trovato
err-group-already-exists = Un gruppo con questo nome esiste già
...
err-tracker-name-too-long = Il nome del tracker è troppo lungo (max { $max_length } caratteri)
err-tracker-address-invalid = Indirizzo del tracker non valido
err-tracker-address-empty = L'indirizzo del tracker non può essere vuoto
err-tracker-address-too-long = L'indirizzo del tracker è troppo lungo (massimo { $max_length } byte)
...
err-tracker-too-many = Limite tracker raggiunto (max { $max })

# Tracker registration status messages
err-tracker-connection-failed = Impossibile connettersi al tracker
err-tracker-tls-failed = Handshake TLS con il tracker fallito
err-tracker-handshake-failed = Handshake del tracker fallito
err-tracker-connection-lost = Connessione al tracker persa
err-tracker-db-failed = Errore database durante l'aggiornamento dello stato del tracker
err-tracker-fingerprint-mismatch = Il certificato del tracker non corrisponde all'impronta digitale memorizzata
err-tracker-fingerprint-intercepted = L'impronta auto-segnalata del tracker non corrisponde al suo certificato TLS
err-tracker-unauthorized = Il tracker ha rifiutato la registrazione
err-tracker-rate-limited = Limitato dal tracker
err-tracker-capacity = Il tracker è alla capacità massima
err-tracker-invalid = Il tracker ha rifiutato la registrazione come non valida
err-tracker-protocol-error = Il tracker ha inviato una risposta di errore malformata
err-tracker-unknown = Il tracker ha segnalato un errore sconosciuto
...
err-slow-client-disconnect = Disconnesso: il tuo client non è riuscito a tenere il passo con i messaggi del server.
