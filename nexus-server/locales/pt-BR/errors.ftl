...
err-status-too-long = A mensagem de ausência é muito longa (máx. { $max_length } bytes)
...
err-broadcast-too-long = Mensagem muito longa (máximo { $max_length } bytes)
err-chat-too-long = Mensagem muito longa (máximo { $max_length } bytes)
...
err-server-name-too-long = O nome do servidor é muito longo (máximo { $max_length } bytes)
...
err-address-too-long = O endereço é muito longo (máximo { $max_length } bytes)
err-address-contains-scheme = O endereço não pode incluir um esquema de URL
err-address-contains-brackets = O endereço não pode incluir colchetes
err-address-contains-path = O endereço não pode incluir um caminho
err-address-contains-userinfo = O endereço não pode incluir um nome de usuário
err-address-contains-whitespace = O endereço não pode conter espaços em branco
err-address-contains-port = O endereço não pode incluir uma porta
err-address-contains-zone-id = O endereço não pode incluir um identificador de zona IPv6
err-address-invalid-format = O endereço não é um nome de host ou endereço IP válido
err-address-empty = O endereço não pode estar vazio

# Erros de notícias
err-news-not-found = Notícia #{ $id } não encontrada
err-news-body-too-long = O conteúdo da notícia é muito longo (máximo { $max_length } bytes)
...
err-tracker-name-too-long = O nome do rastreador é muito longo (máx { $max_length } bytes)
