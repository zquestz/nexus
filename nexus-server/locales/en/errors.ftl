...
err-address-too-long = Address is too long (max { $max_length } bytes)
err-address-contains-scheme = Address must not include a URL scheme
err-address-contains-brackets = Address must not include brackets
err-address-contains-path = Address must not include a path
err-address-contains-userinfo = Address must not include a username
err-address-contains-whitespace = Address must not contain whitespace
err-address-contains-port = Address must not include a port
err-address-contains-zone-id = Address must not include an IPv6 zone identifier
err-address-invalid-format = Address is not a valid hostname or IP address
err-address-empty = Address cannot be empty
