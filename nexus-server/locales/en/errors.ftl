...
err-avatar-unsupported-type = Unsupported avatar type (PNG, JPEG, WebP, or SVG only)
err-avatar-undecodable = Avatar could not be decoded as a valid image
err-authentication = Authentication error
err-invalid-credentials = Invalid username or password
err-login-rate-limited = Too many failed login attempts. Try again later.
...
err-personal-file-area-exists = Personal file area for '{ $username }' already exists
err-personal-file-area-migration-failed = Failed to migrate personal file area
err-personal-file-area-busy = Personal file area is busy
err-personal-file-area-rollback-failed-warning = Personal file area rollback failed; the file area may remain under '{ $new_username }' instead of '{ $old_username }'. Check server logs before retrying.
...
err-server-image-unsupported-type = Unsupported server image type (PNG, JPEG, WebP, or SVG only)
err-server-image-undecodable = Server image could not be decoded as a valid image
...
err-news-image-unsupported-type = Unsupported news image type (PNG, JPEG, WebP, or SVG only)
err-news-image-undecodable = News image could not be decoded as a valid image
...
err-upload-insufficient-space = Not enough free space for upload
