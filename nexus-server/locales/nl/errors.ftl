...
err-personal-file-area-exists = Het persoonlijke bestandsgebied voor "{ $username }" bestaat al
err-personal-file-area-migration-failed = Kan het persoonlijke bestandsgebied niet migreren
err-personal-file-area-busy = Het persoonlijke bestandsgebied is bezet
err-personal-file-area-rollback-failed-warning = Terugdraaien van het persoonlijke bestandsgebied is mislukt; het bestandsgebied staat mogelijk onder "{ $new_username }" in plaats van "{ $old_username }". Controleer de serverlogboeken voordat u het opnieuw probeert.
...
err-server-image-undecodable = Serverafbeelding kon niet worden gedecodeerd als een geldige afbeelding
...
err-news-image-undecodable = Nieuwsafbeelding kon niet worden gedecodeerd als een geldige afbeelding
