...
err-address-too-long = Het adres is te lang (maximaal { $max_length } bytes)
err-address-contains-scheme = Het adres mag geen URL-schema bevatten
err-address-contains-brackets = Het adres mag geen haakjes bevatten
err-address-contains-path = Het adres mag geen pad bevatten
err-address-contains-userinfo = Het adres mag geen gebruikersnaam bevatten
err-address-contains-whitespace = Het adres mag geen spaties bevatten
err-address-contains-port = Het adres mag geen poort bevatten
err-address-contains-zone-id = Het adres mag geen IPv6-zone-identificatie bevatten
err-address-invalid-format = Het adres is geen geldige hostnaam of IP-adres
err-address-empty = Adres mag niet leeg zijn
