...
pub const SUPPORTED_FEATURES: &[&str] = &[FEATURE_CHAT, FEATURE_FILES, FEATURE_NEWS, FEATURE_VOICE];
...
pub const LOG_UPLOAD_SPACE_CHECK_FAILED: &str = "Upload: free space check failed";
pub const LOG_UPLOAD_INSUFFICIENT_SPACE: &str = "Upload: insufficient free space";
...
pub const LOG_USER_UPDATE_PRIVILEGED_PASSWORD: &str =
    "UserUpdate: attempted to reset password of a more-privileged user";
