...
pub fn client_message_type(message: &ClientMessage) -> &'static str {
    match message {
        ...
        ClientMessage::TrackerCreate { .. } => "TrackerCreate",
        ClientMessage::TrackerDelete { .. } => "TrackerDelete",
...
pub fn server_message_type(message: &ServerMessage) -> &'static str {
    match message {
        ...
        ServerMessage::TrackerCreateResponse { .. } => "TrackerCreateResponse",
        ServerMessage::TrackerDeleteResponse { .. } => "TrackerDeleteResponse",
