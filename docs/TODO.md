...
- **Client-side discovery** — `nexus-client` queries one or more
  trackers and surfaces the server listing in the bookmarks /
  server-list UI. (Separate from the admin UI; not yet started.)
