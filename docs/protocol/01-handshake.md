...
| --------- | ------ | -------- | ------------------------------------------- |
| `version` | string | Yes      | Client's protocol version (e.g., `"0.9.3"`) |
...
```
NX|9|Handshake|a1b2c3d4e5f6|19|{"version":"0.9.3"}
```
...
```json
{
  ...
  "version": "0.9.3",
  "fingerprint": "AA:BB:CC:DD:EE:FF:00:11:22:33:44:55:66:77:88:99:AA:BB:CC:DD:EE:FF:00:11:22:33:44:55:66:77:88:99",
  "error": "Unsupported protocol version. Server: 0.9.3, Client: 0.3.0"
}
```
...
| ------ | ------ | ---------- | ------------------------ |
| 0.9.3  | 0.9.3  | ✅ Yes     | Exact match              |
| 0.9.4  | 0.9.3  | ✅ Yes     | Patch difference ignored |
| 0.8.0  | 0.9.3  | ❌ No      | Minor mismatch (pre-1.0) |
| 0.9.3  | 0.8.0  | ❌ No      | Minor mismatch (pre-1.0) |
| 1.0.0  | 0.9.3  | ❌ No      | Major version mismatch   |
| 0.9.3  | 1.0.0  | ❌ No      | Major version mismatch   |
