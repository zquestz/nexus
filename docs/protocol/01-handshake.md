...
| --------- | ------ | -------- | ------------------------------------------- |
| `version` | string | Yes      | Client's protocol version (e.g., `"0.7.4"`) |
...
```
NX|9|Handshake|a1b2c3d4e5f6|20|{"version":"0.7.4"}
```
...
{
  "success": false,
  "error": "Unsupported protocol version. Server: 0.7.4, Client: 0.3.0"
}
```
...
| 0.7.0  | 0.7.4  | ✅ Yes     | Patch difference ignored |
