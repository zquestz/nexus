...
| --------- | ------ | -------- | ------------------------------------------- |
| `version` | string | Yes      | Client's protocol version (e.g., `"0.7.2"`) |
...
{
  "success": false,
  "error": "Unsupported protocol version. Server: 0.7.2, Client: 0.3.0"
}
```
...
| 0.7.0  | 0.7.2  | ✅ Yes     | Patch difference ignored        |
