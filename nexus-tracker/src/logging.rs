//! Tracker logging infrastructure
//!
...
/// Get the log directory path under the given tracker data directory.
#[must_use]
...
/// on startup and (eventually) by a daily timer task.
...
mod tests {
    ...
    fn test_log_dir_under_data_dir() {
        let data = Path::new("/var/lib/nexus-trackerd");
        assert_eq!(log_dir(data), Path::new("/var/lib/nexus-trackerd/logs"));
    }
}
