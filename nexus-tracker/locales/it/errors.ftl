...
err-tracker-name-too-long = Il nome del server è troppo lungo (max { $max_length } byte)
err-tracker-description-too-long = La descrizione del server è troppo lunga (max { $max_length } byte)
