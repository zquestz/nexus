...
err-tracker-refresh-unknown = O registo já não está ativo; volte a ligar para registar novamente
...
err-tracker-unexpected-message-type = Tipo de mensagem inesperado
