...
err-tracker-refresh-unknown = El registro ya no está activo; vuelva a conectarse para registrarse de nuevo
...
err-tracker-unexpected-message-type = Tipo de mensaje inesperado
