...
err-tracker-name-too-long = Le nom du serveur est trop long (max { $max_length } octets)
err-tracker-description-too-long = La description du serveur est trop longue (max { $max_length } octets)
