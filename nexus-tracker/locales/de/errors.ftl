...
err-tracker-name-too-long = Servername ist zu lang (max. { $max_length } Bytes)
err-tracker-description-too-long = Serverbeschreibung ist zu lang (max. { $max_length } Bytes)
